    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                PlateField(
                    label = if (owner) "Your name" else "Their name",
                    value = name,
                    onValueChange = { name = it },
                    placeholder = if (owner) "Priya" else "Baba",
            ...
            AvatarPresetStrip(selectedId = avatarId, onSelect = { avatarId = it })
            ...
            AnimatedVisibility(visible = customising) {
                Column {
                    ...
                    AvatarCustomiser(spec = spec, onChange = { avatarId = it.encode() })
                }
            }
        }
        Column(
