...
<p style="margin:0 0 20px; font-size:15px; line-height:23px; color:#4A5058; text-align:center;">
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px; background:#F2EFE9; border-radius:14px;">
  <tr>
