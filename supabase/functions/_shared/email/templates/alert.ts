...
export const alertTemplate: EmailTemplate = {
  subject: `{{headline}}`,
  html: `<h1 class="ss-h1 ss-ink" style="margin:0 0 10px; font-family:Archivo, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:26px; line-height:32px; font-weight:800; color:#22282E;">
  {{headline}}
</h1>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 22px; background:#F2EFE9; border-radius:10px;">
  <tr>
    <td style="padding:16px 18px; font-size:15px; line-height:23px; color:#4A5058;">
...
<p style="margin:0 0 24px; font-size:13px; line-height:20px; color:#6A7078;">
