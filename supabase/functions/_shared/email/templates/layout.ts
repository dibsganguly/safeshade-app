  ...
  <tr>
    <td align="center" style="padding:28px 12px 36px;">
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" align="center" style="width:600px; max-width:600px;">
        ...
        <tr>
          <td class="ss-pad ss-panel" align="center" style="background:#FFFFFF; border-radius:18px 18px 0 0; padding:26px 32px 20px; text-align:center;">
        ...
        <tr>
          <td class="ss-pad" align="center" style="background:#F6F4EF; border-top:1px solid #E4E0D8; border-radius:0 0 18px 18px; padding:22px 32px 26px; text-align:center; font-family:Archivo, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; font-size:12px; line-height:18px; color:#6A7078;">
            {{{footer}}}
            <div style="margin-top:8px;">
              Replies to this address are not read.
            </div>
            <div style="margin-top:14px; color:#8A9099;">
              SafeShade, Patia, OD, India | CQ5D-OTPM
            </div>
